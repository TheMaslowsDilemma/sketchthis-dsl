...
See the [language spec](https://github.com/TheMaslowsDilemma/sketchthis-dsl/blob/main/LANGUAGE_SPEC.md) for more details. Syntax highlighting file for sublime text editor in repo.
